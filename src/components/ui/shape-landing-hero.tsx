...
function HeroGeometric({
    badge = "AI-Powered Educational Assistant",
    title1 = "Find Your Perfect",
    title2 = "Professor at CUNY & SUNY",
    description = "Get AI-powered insights, ratings, and real student experiences in seconds",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
